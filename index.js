...
//
const BotName = 'nnndbot'; // Nama Bot Whatsapp
const instagramlu = 'https://instagram.com/nnndiiii_'; // Nama Instagramlu cok
const whatsapplu = '081-615-019-293'; // Nomor whatsapplu cok
...
conn.on('user-presence-update', json => console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by @nnndii_`))
conn.on('message-status-update', json =>
{
   const participant = json.participant ? ' (' + json.participant + ')' : '' // participant exists when the message is from a group
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by @nnndiiii_`)
})
